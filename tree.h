...
// Tue Nov 12 09:45:33 2019 by ROOT version 6.16/00
// from TTree tree/tree
// found on file: Lb_Tuple_presel.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Lb_Tuple_presel.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Lb_Tuple_presel.root");
      }
